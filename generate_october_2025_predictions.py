"""
October 2025 Prediction Generation - Sliding Window Methodology
Train: Jan 2020 - Aug 2025 | Validate: Sep 2025 | Predict: Oct 2025
"""
...
# FIXED date configuration for October 2025 sliding-window prediction
# Following same methodology as August & September predictions

TRAIN_END = datetime(2025, 8, 31)       # Train through August 2025
VALIDATION_START = datetime(2025, 9, 1) # Validate on September 2025
VALIDATION_END = datetime(2025, 9, 30)
PREDICTION_START = datetime(2025, 10, 1) # Predict October 2025

TODAY = datetime.now()  # For logging only

print("="*80)
print("OCTOBER 2025 PREDICTIONS - SLIDING WINDOW METHODOLOGY")
print("="*80)
print(f"\n📅 Date Configuration for October 2025 (Run on: {TODAY.date()}):")
print(f"  Training: 2020-01-01 to {TRAIN_END.date()} (Through August 2025)")
print(f"  Validation: {VALIDATION_START.date()} to {VALIDATION_END.date()} (September 2025)")
print(f"  Prediction Target: {PREDICTION_START.date()} onwards (October 2025)")
print(f"  Horizon: {PREDICTION_HORIZON} trading days")
print("\n  ✅ Following same sliding-window methodology as August & September")
print("="*80)
...
if __name__ == "__main__":
    # Fixed configuration for October 2025 predictions
    output_file = 'october_2025_predictions.json'

    print(f"\n🎯 Generating October 2025 predictions...")
    print(f"   Output file: {output_file}")
    print()

    results, allocations = main(train_cutoff_date=None, output_file=output_file)